...
export default function Visit() {
  ...
  return (
    <>
      ...
      <Nav here="/visit" />
      <main>
        <section className="sp visitHero">
          <div>
            <span className="k">Visit</span>
            <h1>Come and stand next to it.</h1>
            <p className="ans">
              Four hours of continuous production, your diameter. We would rather you measured
          ...
          <div className="formCard">
            <span className="k">Or tell us where you are</span>
            <p style={{ fontSize: 14, color: "var(--dim)", fontWeight: 300, marginTop: 8 }}>
